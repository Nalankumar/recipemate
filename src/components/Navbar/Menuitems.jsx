...
export default function Menuitems({isOpen}){
    return(
        <ul className={isOpen?"menu menu-horizontal bg-base-200 rounded-box w-56 md:flex  md:px-[5vw] md:menu-vertical":"hidden menu bg-base-200 rounded-box w-56 md:px-[5vw] menu-horizontal md:menu-vertical"}>
                <li><a>Home</a></li>
                <li><a>Recipes</a></li>
